...
class IslandCommand extends BaseCommand{
    ...
    protected function prepare(): void
    {
        ...
        $this->registerSubCommand(new TrustedKickCommand("trustedkick"));
        $this->registerSubCommand(new TrustedAcceptCommand("trustedaccept"));
        $this->registerSubCommand(new TrustedInviteCommand("trustedinvite"));
