...
class GivePrestigeShards extends BaseSubCommand{

    public const USAGE = "/is addprestigeshards <island_owner> <amount>";
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        $session->sendAdminMessage("Successfully added " . TextFormat::RED . $amount . TextFormat::GRAY . "Prestige Shards to " . TextFormat::RED . $name . TextFormat::GRAY ."'s island!");
        $island->addPrestigeShards($amount);
    }
}