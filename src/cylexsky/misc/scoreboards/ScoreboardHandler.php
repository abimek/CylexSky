...
class ScoreboardHandler{
    ...
    public static function sendPvPScoreboard(Player $player){
        ...
        self::$pvpScoreboard->setLine($player, 1, TextFormat::GRAY . $session->getStatsModule()->getKills() . Glyphs::SWORD_RIGHT);
        self::$pvpScoreboard->setLine($player, 2, TextFormat::GRAY . $session->getStatsModule()->getDeaths() . Glyphs::SKULL);
        self::$pvpScoreboard->setLine($player, 3, TextFormat::RED . $session->getStatsModule()->getKD() . TextFormat::GRAY . " Deaths");
    }
    ...
    public static function sendIslandScoreboard(Player $player){
        ...
        self::$islandScoreboard->setLine($player, 1, TextFormat::GRAY . $session->getMoneyModule()->getMoney() . Glyphs::GOLD_COIN);
        self::$islandScoreboard->setLine($player, 2, TextFormat::GRAY . $session->getMoneyModule()->getOpal() . Glyphs::OPAL);
    }
    ...
    public static function sendTutorialScoreboard(Player $player){
        ...
        self::$islandScoreboard->setLine($player, 1, TextFormat::GRAY . $tutorialModule->getTutorialPhase() . "/" . TutorialModule::LAST_TUTORIAL . Glyphs::SPARKLE);
    }
}