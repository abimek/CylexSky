...
class Level extends BaseModule {
    ...
    private function addLevel(){
        ...
        $this->getSession()->getPlayer()->sendMessage(TextFormat::BOLD_AQUA . "+++++++++++++++++++++++");
        $this->getSession()->getPlayer()->sendTitle(Glyphs::GOLD_MEDAL . TextFormat::GOLD . "You've leveled up!" . Glyphs::GOLD_MEDAL, Glyphs::SPARKLE . TextFormat::BOLD_GREEN . $romanPreviousLevel . " " . TextFormat::BOLD_GOLD . Glyphs::RIGHT_ARROW .  " " .$l . Glyphs::SPARKLE);
    }
    ...
    public function getXpForNextLevel(){
        return floor(pow($this->level, 1.39) * 400);
    }
